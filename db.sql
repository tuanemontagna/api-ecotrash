...
create type tipo_transacao_enum as enum ('GANHO_CODIGO', 'GASTO_VOUCHER', 'GANHO_CAMPANHA', 'GANHO_COLETA');

alter type tipo_transacao_enum owner to postgres;

create type enum_usuarios_tipo_usuario as enum ('PESSOA_FISICA', 'EMPRESA', 'ADMIN');

alter type enum_usuarios_tipo_usuario owner to postgres;
...
(
    ...
    email                       varchar(255)      not null
        unique
        constraint usuarios_email_key1
            unique,
    ...
    codigo_temporario           varchar(255),
    expiracao_codigo_temporario timestamp with time zone
);
